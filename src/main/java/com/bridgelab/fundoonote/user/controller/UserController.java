package com.bridgelab.fundoonote.user.controller;
...
import com.bridgelab.fundoonote.user.service.IUserService;
...
public class UserController {
	...
	public ResponseEntity<UserResponse> login(@RequestBody LoginDto loginDto) throws UserException{
		ResponseEntity<UserResponse> response = new ResponseEntity<UserResponse>(userService.login(loginDto), HttpStatus.OK);
		return response;
	}
	
	@PostMapping("/register")
	public ResponseEntity<UserResponse> register(@RequestBody RegisterDto registerDto) throws UserException{
		ResponseEntity<UserResponse> response = new ResponseEntity<UserResponse>(userService.registration(registerDto), HttpStatus.OK);
		return response;
	}
